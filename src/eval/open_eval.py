...
from src.prompts.localization import FERMAT_USER_PROMPT_DETAILED_AND_LOCALIZATION_FOR_EVAL, SYSTEM_PROMPT, USER_PROMPT_DETAILED_AND_LOCALIZATION, PATTERN_DETAILED_AND_LOCALIZATION
